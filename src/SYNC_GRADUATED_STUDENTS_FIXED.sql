-- ============================================================================
-- SYNC GRADUATED STUDENTS FROM PROFILES TO GRADUATED_STUDENTS TABLE (FIXED)
-- ============================================================================
...
-- Now ON CONFLICT will work because we added the UNIQUE constraint above
...
-- WHAT THIS DOES:
-- ============================================================================
-- ✅ FIRST: Adds UNIQUE constraint on student_id (required!)
